...
QoDesk.QoAdmin.Groups = Ext.extend(Ext.grid.EditorGridPanel, {
   ...
   , constructor : function(config){
      ...
      var searchFieldBtn = new Ext.Button({
         menu: new Ext.menu.Menu({
            items: [
               { checked: true, checkHandler: checkHandler, group: 'filterField', key: 'name', scope: this, text: 'Grupo' }
	   ...
	   Ext.applyIf(config, {
         ...
         , bbar: new Ext.PagingToolbar({
            ...
            , emptyMsg: 'No hay grupos que mostrar'
            , pageSize: 30
            , store: store
         })
         , closable: true
         ...
         , tbar: [
            ...
            , {
               ...
               , scope: this
               , text: 'Eliminar'
               , tooltip: 'Eliminar grupo seleccionado'
            }
            , '-'
            , {
               disabled: true
         ...
         , title: 'Grupos'
	      , viewConfig: {
	         emptyText: 'No hay grupos que mostrar...'
            //, ignoreAdd: true
   ...
   , deleteGroup : function(record){
      Ext.MessageBox.confirm('Confirmación', 'Está seguro de eliminar el grupo No.: ' + record.data.id + '?', function(btn){
         if(btn === "yes"){
            ...
            Ext.Ajax.request({
               callback: function(options, success, response){
                  ...
                  if(success){
                     ...
                     if(fCount > 0){
                        Ext.MessageBox.alert('Advertencia', fCount+' grupo(s) no eliminado(s)!');
                     }
         ...
         callback: function(options, success, response){
            ...
            if(success){
               ...
               if(failed.length > 0){
                  ...
                  Ext.MessageBox.alert('Advertencia', 'No todos los grupos fueron creados!');
               }
               ...
               Ext.MessageBox.alert('Alerta', 'Asigne privilegios al grupo creado!');
            }else{
               Ext.MessageBox.alert('Advertencia', 'Conexión perdida con el servidor!');
            }
         }
