...
Ext.define('fichalectura.view.FichaSenagua', {
	extend: 'fichalectura.view.ui.FichaSenagua',
	...
	initComponent: function() {
		...
		Ext.define('FichaLectura', {
			...
			fields: ['con_id', 'con_formulario', 'con_responsable_datos', 'con_fecha_toma_datos', 'dpa_provincia', 'dpa_canton', 'dpa_parroquia', 'pfastetter', 'hid_id',
				'cue_id', 'sub_id', 'mic_id', 'con_proceso', 'con_fecha_autoriz_ini', 'con_fecha_autoriz_fin', 'rio_autoriz_inicial_id', 'rio_autoriz_actual_id', 'rio_telefono',
                'rio_celular', 'rio_email', 'con_tarifa', 'con_fecha_pago_ini', 'con_fecha_pago_fin', 'con_observaciones', 'con_path', 'con_representante_junta', 'con_direccion',
