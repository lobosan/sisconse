...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="assets/css/grid-filter.css" />
                ...
                columns: [
                    ...
                    {dataIndex: 'mic_id', text: 'Microcuenca', width: 193, filterable: true},
                    {
                        ...
                        items: [{
                            ...
                            disabled: <?=($os->is_group_allowed($group_id, 'ficha', 'editarFicha')) ? 'false' : 'true'?>,
                            handler: function(grid, rowIndex, colIndex) {
                                var row = store.getAt(rowIndex);
                                tabs.add({
                                    title: 'Proceso No. ' + row.get('con_proceso'),
                            ...
                            disabled: <?=($os->is_group_allowed($group_id, 'ficha', 'eliminarFicha')) ? 'false' : 'true'?>,
                            handler: function() {
                    ...
                    tbar: [
                        {
                            ...
                            iconCls: 'add-icon',
                            disabled: <?=($os->is_group_allowed($group_id, 'ficha', 'crearFicha')) ? 'false' : 'true'?>,
                            handler: function() {
                                tabs.add({
                                    title: 'Nueva ficha',
                        ...
                        }, '-',
                        {
                            ...
                            iconCls: 'import-icon',
                            disabled: <?=($os->is_group_allowed($group_id, 'ficha', 'importarExcelFicha')) ? 'false' : 'true'?>,
                            handler: function() {
                                var win;
                                if (!win) {
                        ...
                        }, '-',
                        {
                            ...
                            iconCls:'csv-icon',
                            disabled: <?=($os->is_group_allowed($group_id, 'ficha', 'importarCSVFicha')) ? 'false' : 'true'?>,
                            handler: function() {
                                var win;
                                if (!win) {
                                    win = Ext.create('widget.window', {
                        ...
                        }, '-',
                        {
                            ...
                            iconCls: 'export-icon',
                            disabled: <?=($os->is_group_allowed($group_id, 'ficha', 'exportarExcelFicha')) ? 'false' : 'true'?>,
