   ...
   constructor : function(config){
      ...
      this.contextMenu = new Ext.menu.Menu({
         items: [
            ...
            '-',
            {
               text: 'Ventanas en azulejo',
               handler: this.tileWindows,
               scope: this
            },
            {
               text: 'Ventanas en cascada',
               handler: this.cascadeWindows,
               scope: this
            },
            {
               text: 'Ventanas en cuadrícula',
               handler: this.checkerboardWindows,
               scope: this
            },
            {
               text: 'Ventanas en paralelo',
               handler: this.snapFitWindows,
               scope: this
            },
            {
               text: 'Ventanas apiladas',
   ...
   setWallpaper : function(o){
      if(o && o.id && o.name && o.file){
         ...
         var notifyWin = this.showNotification({
            html: 'Cargando fondo de escritorio...',
      ...
      function verify(){
         if(wp.complete){
            ...
            notifyWin.setMessage('Fondo de pantalla cargado.');
